...
**O que é fixo:** a organização. A estrutura das seções, a ordem dos blocos, os campos que precisam ser preenchidos e quando — isso é padrão e não muda.

**O que nunca é fixo:** a criação em si. Os textos, o roteiro, o tom, as decisões visuais, a forma de contar — tudo isso é pautado pela ideia, e a ideia é o que norteia cada demanda. Nenhum conteúdo é igual a outro, e nenhum deve ser. Os templates e exemplos aqui existem para mostrar como organizar o pensamento, não para ser copiados.

O risco de qualquer padrão é virar engessamento. Esses POPs evitam isso porque definem onde cada coisa fica, não o que cada coisa deve ser.
...
Sempre que uma nova demanda de conteúdo, design ou ação for criada no ClickUp.

### Campos obrigatórios — o que preencher e quando

| Campo | Quando preencher | Regra |
|---|---|---|
| **Nome da tarefa** | Na criação | Sempre a headline, copy ou descrição direta do conteúdo. Nunca nome genérico como "BANNER" ou "vídeo". **Sempre em letras maiúsculas.** |
...
Mapear quem o cliente é através de quem o conhece de verdade — entrevistas rápidas com pessoas do entorno para alimentar o posicionamento, a voz e a identidade da marca.

### Quando usar

Durante a fase de imersão de qualquer projeto de criação de marca da Vizantu, antes de começar a construção visual e estratégica.

### Responsável

Phedro ou Erika — quem estiver liderando o projeto de marca.

### Como funciona

O cliente avisa previamente às pessoas do seu entorno que a Vizantu entrará em contato. A mensagem de abordagem é enviada por WhatsApp pelo responsável do projeto. As entrevistas são feitas online, duram até 20 minutos, não são gravadas.
...
Me chamo [Phedro Borges / Erika Iorrana], sou da Vizantu, a gestora de marcas que está estruturando a campanha do [cliente]. Acredito que ele já te avisou que entraríamos em contato. Estamos construindo a marca dele do zero e estamos numa fase muito importante desse processo: entender quem ele é através de quem o conhece de verdade.

Por isso queria bater um papo rápido com você. São uns 20 minutos pelo celular mesmo, online, sem gravação nenhuma. Só algumas perguntas sobre sua visão do [cliente].

Você teria disponibilidade essa semana ou na próxima para a gente marcar?

Meus horários essa semana:
[dia]: [horários disponíveis]
```

### Regras da mensagem

- Sempre em nome de Phedro ou Erika com nome completo — cria credibilidade
- Usar o nome do entrevistado no início — cria proximidade
- Deixar claro que o cliente já avisou — reduz estranhamento e gera confiança imediata
